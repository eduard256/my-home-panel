...
/**
 * Single switch card using RIGHT channel only (state_right).
 */
export function SingleSwitchRightCard({
  device,
  state,
  isConnected,
  onPublish,
  ...
  const isOn = switchState?.state_right === 'ON';
      ...
      <div className="mt-1">
        ...
        >
          <div className="flex flex-col items-center gap-1">
            <span className="truncate">{device.channelLabels?.right || 'Light'}</span>
...
export default SingleSwitchRightCard;
